                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(controller.weaponQualifications[index].title),
                        Text(
                          controller.weaponQualifications[index].displayDate,
                        ),
                      ],
                    ),
                    Spacer(),
                    GestureDetector(
                      ...
                      arguments: {
                        'date':controller.weaponQualifications[index].displayDate,
                        'name':controller.weaponQualifications[index].weaponName,
                        'pass':controller.weaponQualifications[index].pass,
                        'score':controller.weaponQualifications[index].score,
                        'qualification':controller.weaponQualifications[index].qualificationLevel
                      }
